...
最理想的状态就是，所使用的手机可以放两张卡（国内手机现在都这样），一张国内的一张美国的。然鹅美国的手机大多只有一个卡槽，如果想用第二张卡需要办电子手机卡，然后扫个码扫进手机里（我也不知道这到底是怎么实现的）。
直接在AT&T买了一部新的iphone。可以多说几句，AT&T store是可以购买手机的。不过买之前要确认是不是合约机（合约机会lock其他运营商知道合约结束，这时候国内的卡放进去不work很头疼）。买完以后查一下系统信息是不是还是lock的状态，如果是则需要让店员帮忙解一下。
